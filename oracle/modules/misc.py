...
def _chat(bot, args):
    ...
    if message[0].startswith('.') and (('<' in message and '>' in message) or ('[' in message and ']' in message)):
        bot.msg(nick, 'Hey! Seems like you\'re struggling with these commands.')
        bot.msg(nick, '<> and [] don\'t need to be typed, and are supposed to just tell you whether or not the argument is required.')
